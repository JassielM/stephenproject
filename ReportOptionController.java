...
public class ReportOptionController {
    ...
    public Document createFile(String name) throws IOException,DocumentException{
        String[] names = name.split(" ");
        String dest = names.length > 2 ? "D://Reports/"+names[0]+names[1]+names[2]+".pdf":names.length == 2 ? "D://Reports/"+names[0]+names[1]+".pdf":"D://Reports/"+names[0]+".pdf";
    ...
    public void allStudents(ActionEvent event) throws IOException {
        String term_of_study = "" ;
        while(term_of_study.equalsIgnoreCase("")){
            String prompt = JOptionPane.showInputDialog("Term of Study?");
            if(prompt.equalsIgnoreCase("one")||prompt.equalsIgnoreCase("I")){
                term_of_study = "I";
            } else if (prompt.equalsIgnoreCase("two")||prompt.equalsIgnoreCase("II")) {
                term_of_study = "II";
            } else if (prompt.equalsIgnoreCase("three")||prompt.equalsIgnoreCase("III")) {
                term_of_study = "III";
            }else{
                JOptionPane.showMessageDialog(null,"Invalid term format");
            }
        }
        String class_entered = welcomeController.pupil_class.equalsIgnoreCase("admin") ? JOptionPane.showInputDialog("Enter class of pupils"):welcomeController.pupil_class;
        ...
        try{
            ...
            ResultSet rx,rb,rm,rs;

            if(!class_entered.equalsIgnoreCase("")){
                if(class_entered.equalsIgnoreCase("p1")||class_entered.equalsIgnoreCase("p2")||class_entered.equalsIgnoreCase("p3") ){
                    ArrayList<LowerReport> lowerReportArrayList = new ArrayList<LowerReport>();
                    ReportGenerationController rc = new ReportGenerationController();
                    //Bot Upper
                    String query_lower = "select * from pupil where Class = '"+class_entered+"'";
                    rx = state1.executeQuery(query_lower);
                    while(rx.next()) {
                        String name = rx.getString("Name");
                        String level = "Lower Primary";
                        ...
                        String div_Bot="",stdClass="",math_Bot = "",english_Bot="",lit1_Bot="",lit2_Bot="",reading_Bot="",re_Bot="",totalValue_Bot = "";
                        String div_Mid="",math_Mid = "",english_Mid="",lit1_Mid="",lit2_Mid="",reading_Mid="",re_Mid="",totalValue_Mid = "";

                        String bot_upper = "select * from pupil,bot_l where ID = pupil_ID and Name = '" + name + "'";
                        rb = state2.executeQuery(bot_upper);
                        if (rb.next()) {
                            stdClass = rb.getString("Class");
                        ...
                        //Mid Term
                        String mid_upper = "select * from  pupil,mid_l where ID = pupil_ID and Name = '" + name + "'";
                        rm = state3.executeQuery(mid_upper);
                        if (rm.next()) {
                            stdClass = rm.getString("Class");
                        ...
                        //End of Term
                        String end_upper = "select * from pupil,end_l where ID = pupil_ID and Name = '" + name + "'";
                        rs = state4.executeQuery(end_upper);
                        if (rs.next()) {
                            ...
                            commE = rc.getComment(q_English);
                            commM = rc.getComment(q_Math);
                            commLit1 = rc.getComment(qLit1);
                            commLit2 = rc.getComment(qLit2);
                            commRe = rc.getComment(qRe);
                            commReading = rc.getComment(qReading);
                            totalValue = Integer.toString((rs.getInt("math") + rs.getInt("lit1") + rs.getInt("lit2") + rs.getInt("re")+rs.getInt("reading")+rs.getInt("eng")));
                        }
                        LowerReport pupil = new LowerReport(div, math, english, lit1, lit2, reading, re, totalValue, aggMath, aggEng, aggLit1, aggLit2, aggRe, aggReading, aggTotal, commE, commLit1, commLit2, commM, commReading, commRe, div_Bot, math_Bot, english_Bot, lit1_Bot, lit2_Bot, reading_Bot, re_Bot, totalValue_Bot, div_Mid, math_Mid, english_Mid, lit1_Mid, lit2_Mid, reading_Mid, re_Mid, totalValue_Mid, name, stdClass);
                        lowerReportArrayList.add(pupil);
                    }
                    for(LowerReport report2 : lowerReportArrayList){
                        Document document = createFile(report2.name);
                        document.add(new Paragraph("Name: "+report2.name+"                                            Level: Lower Primary",font1));
                        document.add(new Paragraph("Term: " + term_of_study + "                                            Class: " + report2.std_class, font1));
                        document.add(new Paragraph("  "));
                        ...
                        Phrase res_BotMath = new Phrase(report2.math_Bot, font1);
                        Phrase res_BotEnglish = new Phrase(report2.english_Bot, font1);
                        Phrase res_BotLit1 = new Phrase(report2.lit1_Bot, font1);
                        Phrase res_BotLit2 = new Phrase(report2.lit2_Bot, font1);
                        Phrase res_BotReading = new Phrase(report2.reading_Bot, font1);
                        Phrase res_BotRe = new Phrase(report2.re_Bot, font1);
                        Phrase res_BotTotal = new Phrase(report2.totalValue_Bot, font1);
                        Phrase res_BotGrade = new Phrase(report2.div_Bot, font1);
                        Phrase res_MidMath = new Phrase(report2.math_Mid, font1);
                        Phrase res_MidEnglish = new Phrase(report2.english_Mid, font1);
                        Phrase res_MidLit1 = new Phrase(report2.lit1_Mid, font1);
                        Phrase res_MidLit2 = new Phrase(report2.lit2_Mid, font1);
                        Phrase res_MidRe = new Phrase(report2.re_Mid, font1);
                        Phrase res_MidReading = new Phrase(report2.reading_Mid, font1);
                        Phrase res_MidTotal = new Phrase(report2.totalValue_Mid, font1);
                        Phrase res_MidGrade = new Phrase(report2.div_Mid, font1);
                        ...
                        Phrase ph1Lit1 = new Phrase("LIT 1", font1);
                        Phrase ph1Lit2 = new Phrase("LIT 2", font1);
                        Phrase ph1Re = new Phrase("RE", font1);
                        Phrase ph1Reading = new Phrase("READING", font1);
                        ...
                        Phrase resMath = new Phrase(report2.math, font1);
                        Phrase resEnglish = new Phrase(report2.english, font1);
                        Phrase resLit1 = new Phrase(report2.lit1, font1);
                        Phrase resLit2 = new Phrase(report2.lit2, font1);
                        Phrase resReading = new Phrase(report2.reading, font1);
                        Phrase resRe = new Phrase(report2.re, font1);
                        Phrase resTotal = new Phrase(report2.totalValue, font1);
                        Phrase aM = new Phrase(report2.aggMath, font1);
                        Phrase aE = new Phrase(report2.aggEng, font1);
                        Phrase aLit2 = new Phrase(report2.aggLit2, font1);
                        Phrase aLit1 = new Phrase(report2.aggLit1, font1);
                        Phrase aRe = new Phrase(report2.aggRe, font1);
                        Phrase aReading = new Phrase(report2.aggReading, font1);
                        Phrase aT = new Phrase(report2.aggTotal, font1);
                        Phrase commentMath = new Phrase(report2.commM, font1);
                        Phrase commentEnglish = new Phrase(report2.commE, font1);
                        Phrase commentLit1 = new Phrase(report2.commLit1, font1);
                        Phrase commentLit2 = new Phrase(report2.commLit2, font1);
                        Phrase commentReading = new Phrase(report2.commReading, font1);
                        Phrase commentRe = new Phrase(report2.commRe, font1);
                        ...
                        document.add(new Paragraph("Total Marks: " + report2.totalValue + "                   Total Aggregates: " + report2.aggTotal + "             Div: " + report2.div));
                        document.add(new Paragraph("Remarks: "+rc.ClassTeacherReport_Lower(report2.div)));
                        document.add(new Paragraph(""));
                        document.add(new Paragraph("GENERAL REPORT:",font1));
                        document.add(new Paragraph("Cleanliness: Very Clean and organized"));
                        document.add(new Paragraph("Conduct: Very Disciplined and Organized"));
                        document.add(new Paragraph("  "));
                        document.add(new Paragraph("HeadMaster/HeadMistress' Report:"+rc.HeadTeacherReport_Lower(report2.div),font1));
                        document.add(new Paragraph("HeadTeacher's Signature: ...........................  "));
                        document.add(new Paragraph("  "));
                    ...
                    JOptionPane.showMessageDialog(null,class_entered+" reports generated successfully");
                }else if(class_entered.equalsIgnoreCase("p5") || class_entered.equalsIgnoreCase("p4") ||class_entered.equalsIgnoreCase("p6")||class_entered.equalsIgnoreCase("p7")){

                    ArrayList<UpperReport> upperReportArrayList = new ArrayList<UpperReport>();
                    ReportGenerationController rc = new ReportGenerationController();
                    //Bot Upper
                    String query_lower = "select * from pupil where Class = '"+class_entered+"'";
                    rx = state1.executeQuery(query_lower);
                    while(rx.next()) {
                        ...
                        if (rm.next()) {
                            ...
                            Mid_UpperPrimaryController pr_mid = new Mid_UpperPrimaryController();
                            int agMidMath = pr_mid.getAgg(qMidMath);
                            int agMidEnglish = pr_mid.getAgg(qMidEnglish);
                            int agMidScience = pr_mid.getAgg(qMidScience);
                            int agMidSST = pr_mid.getAgg(qMidSST);
                            int totalAggMid = agMidMath + agMidEnglish + agMidScience + agMidSST;
                            div_Mid = pr_mid.getDiv(totalAggMid);
                        ...
                        //End of Term
                        String end_upper = "select * from pupil,end_u where ID = pupil_ID and Name = '" + name + "'";
                        rs = state4.executeQuery(end_upper);
                        if (rs.next()) {
                            ...
                            commE = rc.getComment(qEnglish);
                            commM = rc.getComment(qMath);
                            commS = rc.getComment(qScience);
                            commSST = rc.getComment(qSST);
                            totalValue = Integer.toString(qSST + qEnglish + qMath + qScience);
                        }
                        UpperReport pupil = new UpperReport(std_class,div, math, english, sst, science, totalValue, aggMath,aggEng,aggSST, aggScience,aggTotal, commE, commS, commSST, commM, div_Bot, math_Bot, english_Bot, sst_Bot, science_Bot, totalValue_Bot, div_Mid, math_Mid, english_Mid, sst_Mid, science_Mid, totalValue_Mid, name, level);
                        upperReportArrayList.add(pupil);
                    }
                    for(UpperReport report : upperReportArrayList){

                        Document document = createFile(report.name);
                        document.add(new Paragraph("Name: "+report.name+"                                            Level: "+report.level,font1));
                        document.add(new Paragraph("Term: " + term_of_study + "                                            Class: " + report.std_class, font1));
                        document.add(new Paragraph("  "));
                        ...
                        Phrase phG = new Phrase("GRADE", font1);
                        Phrase ph6 = new Phrase("     ", font1);
                        Phrase res_BotMath = new Phrase(report.math_Bot, font1);
                        Phrase res_BotEnglish = new Phrase(report.english_Bot, font1);
                        Phrase res_BotSST = new Phrase(report.sst_Bot, font1);
                        Phrase res_BotScience = new Phrase(report.science_Bot, font1);
                        Phrase res_BotTotal = new Phrase(report.totalValue_Bot, font1);
                        Phrase res_BotGrade = new Phrase(report.div_Bot, font1);
                        Phrase res_MidMath = new Phrase(report.math_Mid, font1);
                        Phrase res_MidEnglish = new Phrase(report.english_Mid, font1);
                        Phrase res_MidSST = new Phrase(report.sst_Mid, font1);
                        Phrase res_MidScience = new Phrase(report.science_Mid, font1);
                        Phrase res_MidTotal = new Phrase(report.totalValue_Mid, font1);
                        Phrase res_MidGrade = new Phrase(report.div_Mid, font1);
                        ...
                        //creating phrases for results
                        Phrase resMath = new Phrase(report.math, font1);
                        Phrase resEnglish = new Phrase(report.english, font1);
                        Phrase resSST = new Phrase(report.sst, font1);
                        Phrase resScience = new Phrase(report.science, font1);
                        Phrase resTotal = new Phrase(report.totalValue, font1);
                        Phrase aM = new Phrase(report.aggMath, font1);
                        Phrase aE = new Phrase(report.aggEng, font1);
                        Phrase aSS = new Phrase(report.aggSST, font1);
                        Phrase aS = new Phrase(report.aggScience, font1);
                        Phrase aT = new Phrase(report.aggTotal, font1);
                        Phrase commentMath = new Phrase(report.commM, font1);
                        Phrase commentEnglish = new Phrase(report.commE, font1);
                        Phrase commentScience = new Phrase(report.commS, font1);
                        Phrase commentSST = new Phrase(report.commSST, font1);
                        ...
                        document.add(new Paragraph(" "));
                        document.add(new Paragraph("CLASS TEACHER'S REPORT:", font1));
                        document.add(new Paragraph("Total Marks: " + report.totalValue + "                   Total Aggregates: " + report.aggTotal + "             Grade: " + report.div));
                        document.add(new Paragraph("Remarks: "+rc.ClassTeacherReport_Upper(report.div)));
                        document.add(new Paragraph(""));
                        document.add(new Paragraph("GENERAL REPORT:", font1));
                        document.add(new Paragraph("Cleanliness: Generally Clean and organized"));
                        document.add(new Paragraph("Conduct: Very Good"));
                        document.add(new Paragraph("  "));
                        document.add(new Paragraph("HeadMaster/HeadMistress' Report :" + rc.HeadTeacherReport_Upper(report.div), font1));
                        document.add(new Paragraph("HeadTeacher's Signature: ...........................  "));
                        document.add(new Paragraph("  "));
                        document.add(new Paragraph("Next Term Starts On:...........................", font1));
                        document.add(new Paragraph("1. This Report was issued without any arasure or alteration whatsoever"));
                        document.add(new Paragraph("2. This Report is not valid without HeadMaster's official stamp and signature"));
                        document.add(new Paragraph("  "));
                        document.add(new Paragraph("  "));
                    ...
                    JOptionPane.showMessageDialog(null,class_entered+" reports generated successfully");
                }else if(class_entered.equalsIgnoreCase("Baby")||class_entered.equalsIgnoreCase("middle")||class_entered.equalsIgnoreCase("top")){
                    ArrayList<NurseryReport> nurseryArray = new ArrayList<NurseryReport>();
                    ...
                    String query_lower = "select * from pupil,nursery where ID = pupil_ID";
                    rs = state1.executeQuery(query_lower);
                    while(rs.next()){
                        String name = rs.getString("Name");
                        String level = "Nursery";
                        ...
                        NurseryReport pupil = new NurseryReport(name,level,shading,bkWorking,sharing,games,E_comp,E_spoken,err,numbers,reading,alphabet,lrr,singing,drawing,cleanliness,gb,th);
                        nurseryArray.add(pupil);

                    }
                    for (NurseryReport report: nurseryArray){
                        Document document = createFile(report.name);
                        document.add(new Paragraph("Name: "+report.name+"                                            Level: "+report.level,font1));
                        ...
                        //phrases for results
                        Phrase resPh1 = new Phrase(report.E_comp,font1);
                        Phrase resPh2 = new Phrase(report.E_spoken,font1);
                        Phrase resPh3 = new Phrase(report.err,font1);
                        Phrase resPh4 = new Phrase(report.sharing,font1);
                        Phrase resPh5 = new Phrase(report.numbers,font1);
                        Phrase resPh6 = new Phrase(report.reading,font1);
                        Phrase resPh7 = new Phrase(report.alphabet,font1);
                        Phrase resPh8 = new Phrase(report.shading,font1);
                        Phrase resPh9 = new Phrase(report.lrr,font1);
                        Phrase resPh10 = new Phrase(report.singing,font1);
                        Phrase resPh11 = new Phrase(report.drawing,font1);
                        Phrase resPh12 = new Phrase(report.games,font1);
                        Phrase resPh13 = new Phrase(report.cleanliness,font1);
                        Phrase resPh14 = new Phrase(report.gb,font1);
                        Phrase resPh15 = new Phrase(report.th,font1);
                        Phrase resPh16 = new Phrase(report.bkWorking,font1);
                    ...
                    JOptionPane.showMessageDialog(null,"That is not a recognized class");
                }
            }else{
    ...
    public void SpecificStudent(ActionEvent event) throws IOException{
        root = FXMLLoader.load(getClass().getResource("report_generation.fxml"));
