...
public class Upper_UpdateOptions {
    @FXML
    private Parent root;
    @FXML
    private Stage stage;
    ...
    public void beginning(ActionEvent event) throws IOException {
        root = FXMLLoader.load(getClass().getResource("bot_updateUpper.fxml"));
    ...
    public void mid_term(ActionEvent event) throws IOException{
        root = FXMLLoader.load(getClass().getResource("mid_updateUpper.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        stage.setScene(new Scene(root));
        stage.show();
    }
    ...
    public void end_of_term(ActionEvent event) throws IOException{
        root = FXMLLoader.load(getClass().getResource("end_updateUpper.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        stage.setScene(new Scene(root));
        stage.show();
    }
